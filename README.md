...
- <strong>More experimental features have been activated ([see the full list](https://github.com/Pearlism/SpotPearl))</strong>
...
#### Just download and run [Install.bat](https://raw.githack.com/amd64fox/SpotPearl/main/Install_New_theme.bat)
...
```ps1
iex "& { $(iwr -useb 'https://raw.githubusercontent.com/SpotPearl/main/run.ps1') } -v 1.2.13.661.ga588f749-4064 -confirm_spoti_recomended_over -block_update_on"
```
